...
const handleAddToCart = (product: any) => {
	...
	return (
		<div className="container mx-auto px-4 pt-1 pb-8 min-h-screen bg-background">
			<div className="mb-8">
						...
						>
							...
							<CardContent className="p-1.5 flex-1 flex flex-col justify-between">
								<Link href={`/products/${product.id}`} className="block">
									<h3 className="text-xs font-semibold hover:text-blue-600 dark:hover:text-blue-400 transition-colors line-clamp-2 mb-0.5">
										{product.name}
									</h3>
								</Link>
								{/* Rating */}
								<div className="flex items-center gap-0.5 text-[9px] text-gray-500 dark:text-gray-400 mb-0.5">
								...
								<div className="flex gap-1 mt-0.5">
									<Button
										...
										className="flex-1 text-[10px] h-6 w-full"
									>
